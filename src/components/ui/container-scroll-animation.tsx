...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="relative flex h-[46rem] items-center justify-center p-2 md:h-[78rem] md:p-20"
      ref={containerRef}
    >
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="mx-auto -mt-12 h-[30rem] w-full max-w-5xl rounded-[30px] border border-border bg-card p-2 shadow-2xl md:h-[40rem] md:p-4"
    >
