...
const slides=[
 {id:'01',t:'dark',h:wrap('dark','◆ O número',`<div class="bignum">5<small>min</small></div><p class="statsub">é o tempo pra responder um lead. Depois disso, a chance de fechar ele <b>cai 80%</b>.</p><div class="src">Fonte: Harvard Business Review · Lead Response Study</div>`)},
