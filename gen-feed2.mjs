...
.bignum small{font-size:84px;font-weight:700;-webkit-text-fill-color:#3bb7a6}.statsub{font-size:42px;font-weight:500;line-height:1.18;color:#c7cdc7;margin-top:22px;max-width:780px}.statsub b{color:#3bb7a6;font-weight:700}
.src{font-family:'Geist Mono',monospace;font-size:18px;letter-spacing:.03em;margin-top:34px;display:inline-flex;align-items:center;gap:9px}.src::before{content:'↳'}.light .src{color:#1b7a6f}.dark .src{color:#3bb7a6}
...
const slides=[
 {id:'01',t:'dark',h:wrap('dark','◆ O número',`<div class="bignum">5<small>min</small></div><p class="statsub">é o tempo que decide se o lead fica com você ou some pro concorrente.</p>`)},
 ...
 {id:'05',t:'dark',h:wrap('dark','◆ A conta que ninguém faz',`<h2 class="h-bg">Quanto custa um paciente que <em>some?</em></h2><div class="receipt"><div class="rrow"><span class="lab">1 paciente que não volta</span><b>R$ 1.200</b></div><div class="rrow"><span class="lab">Somem por mês (média)</span><b>× 8</b></div><div class="rdiv"></div><div class="rtot"><span class="lab">Por ano, no ralo</span><span class="val">R$ 115 mil</span></div></div><div style="font-family:'Geist Mono',monospace;font-size:17px;color:#93a09a;margin-top:18px">* exemplo ilustrativo, faça a conta com os seus números</div>`)},
 ...
 {id:'11',t:'light',h:wrap('light','◆ O resultado',`<p class="quote">A clínica que para de <em>perder paciente</em> sem nem perceber.</p><p class="qby">é isso que um sistema sob medida entrega.<br>* representação ilustrativa</p>`,'ver mais →')},
 {id:'12',t:'light',h:wrap('light','◆ Como funciona',`<h2 class="cmptitle" style="font-size:56px">Do contrato ao sistema: <em>30 dias.</em></h2><div class="tl"><div class="tlstep"><div class="tlnode">1</div><div class="tlc"><div class="rg">Dias 1 a 3</div><h4>Diagnóstico</h4><p>Mapeia a operação e os gargalos.</p></div></div><div class="tlstep"><div class="tlnode">2</div><div class="tlc"><div class="rg">Dias 4 a 7</div><h4>Arquitetura</h4><p>Desenha o sistema sob medida.</p></div></div><div class="tlstep"><div class="tlnode">3</div><div class="tlc"><div class="rg">Dias 8 a 21</div><h4>Implementação</h4><p>CRM, automações e agentes de IA.</p></div></div><div class="tlstep"><div class="tlnode">4</div><div class="tlc"><div class="rg">Dias 22 a 30</div><h4>Go-live</h4><p>No ar, equipe treinada, monitorado.</p></div></div></div>`,'agende no link')},
];
