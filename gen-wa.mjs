...
.slide{position:relative;width:1080px;height:1350px;overflow:hidden;font-family:'Geist',sans-serif;background:#f3efe5;color:#15201c;padding:70px 66px;display:flex;flex-direction:column}
...
.brand{display:flex;align-items:center;gap:13px}.brand img{height:34px}.brand .dv{width:1px;height:26px;background:#cdc6b6}.brand .wn{font-size:21px;font-weight:600;letter-spacing:.32em}
...
.wtitle{font-size:50px;font-weight:700;line-height:1.06;margin:6px 0 16px;max-width:880px}
.wstage{flex:1;display:flex;align-items:center;justify-content:center}
.wphone{width:572px;height:940px;border-radius:42px;background:#0b141a;border:10px solid #11201c;overflow:hidden;box-shadow:0 44px 90px rgba(0,0,0,.24)}
.wbar{background:#1f2c33;color:#e9edef;display:flex;align-items:center;gap:11px;padding:20px 19px 14px}
.wav{width:40px;height:40px;border-radius:50%;background:linear-gradient(135deg,#2a8c81,#3bb7a6);display:flex;align-items:center;justify-content:center}.wav img{height:21px}
.wbar .nm{font-weight:700;font-size:18px}.wbar .on{font-size:12.5px;color:#8fb3a9}
.wbody{background:#0b141a;padding:15px 14px;display:flex;flex-direction:column;gap:8px}
.bub{max-width:84%;padding:11px 14px;border-radius:14px;font-size:16.5px;line-height:1.3}
...
.tme{font-size:10.5px;opacity:.6;margin-top:3px;text-align:right}
.sysn{align-self:center;background:#182229;color:#9fd0c4;font-size:12.5px;padding:6px 12px;border-radius:9px;text-align:center;max-width:92%}
...
<main>
 ...
 <div class="wstage"><div class="wphone">
  ...
  <div class="wbody">
   ...
   <div class="bub out">Prazer, Marina! É pra harmonização? Seria a sua primeira vez na clínica?<div class="tme">23:14 ✓✓</div></div>
   <div class="bub inc">Isso, primeira vez. Queria entender melhor antes 🙂</div>
   <div class="bub out">Perfeito. A primeira consulta é uma avaliação completa: a Dra. analisa o seu rosto, entende o seu objetivo e monta um plano só pra você. Nada é feito sem te explicar tudo antes 💚<div class="tme">23:15 ✓✓</div></div>
   <div class="bub inc">Que ótimo! E quanto fica?</div>
   <div class="bub out">A avaliação é R$ 350 — e esse valor vira crédito se você seguir com o plano. Posso já reservar um horário?<div class="tme">23:15 ✓✓</div></div>
   <div class="bub inc">Pode sim!</div>
   <div class="bub out">Prontinho: quinta, 15h ✓ te confirmo no dia 👋<div class="tme">23:16 ✓✓</div></div>
